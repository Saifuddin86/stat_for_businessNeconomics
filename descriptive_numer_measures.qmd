...
**Equivalently**, if an observation $x_i$ falls outside the interval $[\bar x-z\cdot s,\bar x+z\cdot s]$.
:::
...
![](images/clipboard-1914441999.png)
...
Let we have a sample data $X=\{x_1,x_2,...,x_n\}$ from a population. The following formulas are used to measure skewness and kurtosis from a sample data [@newbold2013].
